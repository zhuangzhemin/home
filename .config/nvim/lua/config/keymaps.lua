...
map("n", "z0", "<cmd>set foldlevel=0<cr>", { desc = "Set Fold Level 0"})
map("n", "z1", "<cmd>set foldlevel=1<cr>", { desc = "Set Fold Level 1"})
map("n", "z2", "<cmd>set foldlevel=2<cr>", { desc = "Set Fold Level 2"})
map("n", "z3", "<cmd>set foldlevel=3<cr>", { desc = "Set Fold Level 3"})
map("n", "z4", "<cmd>set foldlevel=4<cr>", { desc = "Set Fold Level 4"})
map("n", "z5", "<cmd>set foldlevel=5<cr>", { desc = "Set Fold Level 5"})
map("n", "z6", "<cmd>set foldlevel=6<cr>", { desc = "Set Fold Level 6"})
